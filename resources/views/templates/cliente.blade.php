...
<header>
  ...
  <ul id="dropdown1" class="dropdown-content">
    ...
    <li class="divider"></li>
    <li><a href="/cliente/logout">Salir</a></li>
  </ul>
  ...
  <nav class="deep-purple darken-4">
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a href="/cliente/tienda"><i class="fa fa-shopping-bag"></i>&nbsp Tienda</a></li>
        <li><a href="/cliente/carrito"><i class="fa fa-shopping-cart"></i>&nbsp Carrito</a></li>
        <li><a href="/cliente/acerca"><i class="fa fa-question-circle"></i>&nbsp Acerca</a></li>
        <li><a href="/cliente/contacto"><i class="fa fa-envelope"></i>&nbsp Contacto</a></li>
        <li><a class="dropdown-button" href="#!" data-activates="dropdown1">{{session()->get('cliente')->nombre}}&nbsp&nbsp<i class="fa fa-angle-down" aria-hidden="true"></i>
</a></li>
      </ul>
      <ul class="side-nav" id="mobile-demo">
        ...
        <li><a class="dropdown-button" href="#!" data-activates="dropdown2">{{session()->get('cliente')->nombre}} &nbsp&nbsp<i class="fa fa-angle-down" aria-hidden="true"></i>
</a></li>
      </ul>
    </div>
  </nav>        
